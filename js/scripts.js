$(document).ready(function () {
    ...
    for (var i = 0; i < share_bar.length; i++) {
        var html = '<iframe allowtransparency="true" frameborder="0" scrolling="no"' +
            'src="https://platform.twitter.com/widgets/tweet_button.html?url=' + encodeURIComponent(window.location) + '&amp;text=' + encodeURIComponent(document.title) + '&amp;via=ArabsAlcaide&amp;hashtags=TeamFarrabs&amp;count=horizontal"' +
            'style="width:105px; height:21px;">' +
            '</iframe>' +

            '<iframe src="//www.facebook.com/plugins/like.php?href=' + encodeURIComponent(window.location) + '&amp;width&amp;layout=button_count&amp;action=like&amp;show_faces=false&amp;share=true&amp;height=21&amp;appId=1162704363743786&amp;width=150" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:150px; height:21px;" allowTransparency="true"></iframe>' +
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Redan and Farrah's Wedding",

            // Event start date
            start: new Date('Feb 10, 2023 10:00'),
            ...
            end: new Date('Feb 10, 2023 18:00'),

            // Event Address
            address: 'Hillbarn Tagaytay, 4WCP+34X, Daang Luma, Tagaytay, 4120 Cavite, Philippines',

            // Event Description
            description: "We can't wait to see you on our big day. For any queries or issues, please contact Mr. Redan Benedict Alcaide at +639777953006."
        }
    });
